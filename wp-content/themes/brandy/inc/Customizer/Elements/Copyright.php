...
class Copyright extends AbstractBaseElement {
	...
	protected function register_components() {
		return array(
			'content'           => array(
				'type'           => 'PrefilledHTML',
				'default_value'  => sprintf( '© [current_year] [site_title] - WordPress theme by <a href="%s" target="_blank">Brandy</a>.', 'https://wpbrandy.com/' ),
				...
				'prefilleds'     => array(
					array(
						'label' => '© [current_year]. Make with [heart_icon] by [theme_author]',
						'value' => '© [current_year]. Make with [heart_icon] by [theme_author]',
					),
					array(
